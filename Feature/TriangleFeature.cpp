...
void TriangleFeature::createPipeline()
{
    ...
    // 2. Shader Stage 등록하기
    const int iNumberOfShaderStage = 2;
    VkPipelineShaderStageCreateInfo stages[iNumberOfShaderStage]{};
    ...
    pCI.stageCount = iNumberOfShaderStage;
    pCI.pStages = stages;

    // 3. Vertex Input State 등록하기
    ...
    // 4. Input Assembly State - Triangle or Point
