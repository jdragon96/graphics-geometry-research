 ...
 * MacOS에서 Uniform Buffer를 사용하기 위해서 반드시 Description Layout 할당 필요함
 * ============================================================
 * TIL
...
public:
    ...
    void onRender(const RenderContext &ctx) override
    {
        ...
        // !!! MacOS에서는 Descriptor Set을 반드시 바인딩 해줘야 한다고 함(클로드 왈)
    ...
    void onImGui() override
    {
        ...
        // TODO:
        ImGui::SliderFloat("Angle of Axis Z(Degree)", &fAngleOfAxisZ, 0, 0);
...
void main() {
    ...
    void createUBO()
    {
        // TODO: Uniform Buffer byte size 계산하기
        VkDeviceSize size = 0;

        VkBufferCreateInfo kBufferCreateInfo{};
        kBufferCreateInfo.sType = VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO;
        kBufferCreateInfo.size = size;
        // TODO: Uniform Buffer 생성하기
        // kBufferCreateInfo.usage =
