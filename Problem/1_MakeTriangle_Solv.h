...
/*
 * ============================================================
 *  [Solution 1] Triangle 그리기 - 정답
 * ============================================================
 *
 * (A) Input Assembly → VK_PRIMITIVE_TOPOLOGY_TRIANGLE_LIST
 * (B) createVertexBuffer() → VkBuffer + VkDeviceMemory 생성 및 데이터 업로드
 * (C) Fragment Shader → layout(location=0) out vec4 outColor 선언 및 출력
 * ============================================================
 */
...
class MakeTriangleSolv : public IFeature
{
public:
    const char* name() const override { return "1. Make Triangle (Solution)"; }
